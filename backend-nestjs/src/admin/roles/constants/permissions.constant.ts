...
export const PERMISSIONS_METADATA = [
  {
    ...
    permissions: [
      ...
      {
        code: PERMISSIONS.MANAGE_TENANTS,
        description: 'Gestionar inquilinos/empresas',
      },
    ],
  },
  {
    ...
    permissions: [
      {
        code: PERMISSIONS.LIST_TENANT_ADMINS,
        description: 'Listar administradores de empresa',
      },
      {
        code: PERMISSIONS.CREATE_TENANT_ADMINS,
        description: 'Crear administradores de empresa',
      },
      {
        code: PERMISSIONS.EDIT_TENANT_ADMINS,
        description: 'Editar administradores de empresa',
      },
      {
        code: PERMISSIONS.CHANGE_PASSWORD_TENANT_ADMINS,
        description: 'Cambiar contraseña de administradores',
      },
      {
        code: PERMISSIONS.DELETE_TENANT_ADMINS,
        description: 'Eliminar administradores de empresa',
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      {
        code: PERMISSIONS.EDIT_SYLLABUS,
  ...
  },
  {
    ...
    permissions: [
      {
        code: PERMISSIONS.VIEW_ACADEMIC_TIME,
        description: 'Ver ciclos y semanas académicas',
      },
      {
        code: PERMISSIONS.MANAGE_ACADEMIC_TIME,
        description: 'Gestionar ciclos, semanas y plantillas',
      },
    ],
  },
  {
    ...
    permissions: [
      {
        code: PERMISSIONS.VIEW_CATALOGS,
        description: 'Ver catálogo de cursos y temas',
      },
      {
        code: PERMISSIONS.EDIT_CATALOGS,
        description: 'Gestionar visibilidad de temas',
      },
    ],
  },
  {
    ...
    permissions: [
      {
        code: PERMISSIONS.VIEW_MATERIALS,
        description: 'Ver materiales generados',
      },
      {
        code: PERMISSIONS.EDIT_MATERIALS,
        description: 'Editar o auditar materiales',
      },
    ],
  },
];
